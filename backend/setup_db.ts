...
const crearTablas = async () => {
    ...
    try {
        ...
        // 12. Sembrado de Usuarios de prueba
        const saltRounds = 10;
        ...
        if (existAlumno.rows.length === 0) {
            ...
            // Asociar a la tabla de alumno
            const cursoRes = await pool.query('SELECT id_curso FROM curso WHERE nombre_curso = $1', ['3ro 1ra']); // o por defecto
            ...
            console.log(`🌱 Alumno de prueba sembrado: ${correoAlumno}`);
        }
        ...
        if (existProf.rows.length === 0) {
            ...
            console.log(`🌱 Profesor de prueba sembrado: ${correoProfesor}`);
        }
        ...
        // 14. Sembrado de Clases Secundarias por Defecto
        const clasesDefecto = [
        ...
        for (const c of clasesDefecto) {
            ...
            if (existClase.rows.length === 0) {
                ...
                console.log(`🌱 Clase secundaria sembrada: ${c.nombre}`);
            }
        }
